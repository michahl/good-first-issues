                ...
                {(checked ?savedData : issues).map(issue => (
                    <div className='bg-[#1c1c1c] hover:bg-[#1e1e1e] border border-[#242424] rounded-xl mb-4 relative hover:shadow-xl transition-shadow ease-in-out duration-200' key={issue.id}>
                        ...
                        <div className='px-4 py-3.5'>
                            <a href={issue.html_url} target='_blank' className='text-blue-500/80 text-xl font-semibold hover:underline'>{issue.title}</a>
                            <p className='text-sm text-zinc-500 dark:text-zinc-400 mb-3'>{issue.repository_name}</p>
                            <div className='flex flex-wrap items-center text-sm text-[#858585]'>
